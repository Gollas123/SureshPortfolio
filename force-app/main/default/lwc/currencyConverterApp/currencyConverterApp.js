...
export default class CurrencyConverterApp extends LightningElement {
  ...
  key = '3a5275b8f6msh6edd8cd8e97c04fp1e1f46jsn63993ca644c2';
  ...
  // async convert(){
  //   const API_URL = `https://v6.exchangerate-api.com/v6/d0e6f6b92ef38f26ca09fcd6/latest/USD`;
  //   // `https://api.exchangerate.host/convert?from=${this.countryFrom}&to=${this.countryTo}`
  //   try{
  ...
  async convert(){
    ...
    const API_KEY = '365d5e0f76415f26adde72b2';
